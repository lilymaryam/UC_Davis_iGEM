...
def calcbg_fromdatafile(dnafile):
	#Will calculate the general nucleotide distribution frequency of the DNA 
	#sequence file when markov models are used for background promoter sequence.
	A = 0
	C = 0
	G = 0
	T = 0
...
if __name__ == '__main__':
	...
	#condenseddata)
	print(calcbg_frompromfile(promfile))
